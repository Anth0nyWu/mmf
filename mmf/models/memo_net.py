...
class Memo_net(Pythia):
    ...
    def _init_text_embeddings(self, attr="text"): #question
    ...
    def _init_question_embedding():

    def process_RGC_embedding():

    def process_question_embedding():

    def _init_visualGN_embedding():

    def process_visualGN_embedding():

    def _init_textualGN_embedding():
